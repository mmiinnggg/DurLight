...
parser.add_argument('--dataset', type=str, default='3x3', help='dataset name')
###
parser.add_argument('--identifier', type=str, default='anon_3x3_500_06', help='identifier') # real_hz5734， real_hz5816
parser.add_argument('--config_file', type=str, default='./data/config_anon_3x3_500_06.json', help='path of config file')
parser.add_argument('--save_dir', type=str, default="model/anon_3x3_500_06", help='directory in which model should be saved')
parser.add_argument('--log_dir', type=str, default="log/anon_3x3_500_06", help='directory in which logs should be saved')
...
def train(in_args=args):
    ...
    plot_data_lists([episode_travel_time], ['travel time'],
                    figure_name=args.log_dir + '/' + args.identifier + '_potent_' + str(args.eta) + '_' + str(
